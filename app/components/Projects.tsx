...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "FinanceFlow",
      description:
        "FinanceFlow is your zesty finance buddy—track expenses, set goals, split trip costs, and game your way to financial glory, all while keeping an eye on your progress with a snazzy dashboard!",
      tech: ["Next.js","Typescript","AIML","React.js"],
      liveUrl: "#",
    ...
    },
    {
      ...
      description:"Build on Base using OnchainKit.",
      tech: ["Next.js", "Blockchain", "SoulBound", "Firebase"],
      liveUrl: "#",
      githubUrl: "https://github.com/RushikeshYeole24/Base-X-Clubs",
      status: "Concept",
      year: "2024",
